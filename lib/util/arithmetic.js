...
function multiply(a, b) {
  var aryA = ('' + a).split('e');
  var aryB = ('' + b).split('e');
  var intA = parseInt(aryA[0].replace('.', ''), 10);
  var intB = parseInt(aryB[0].replace('.', ''), 10);
  var count = getDecimalDigitCount(aryA[0]) + getDecimalDigitCount(aryB[0]);
  var countE = parseInt(aryA[1] || '0', 10) + parseInt(aryB[1] || '0', 10);
  var aryP = ('' + intA * intB).split('e');
